...
function StructuredData({
  ...
  const faqSchema = {
    ...
    mainEntity: [
      {
        "@type": "Question",
        name: "What technologies does Chirag Kumar specialize in?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Chirag specializes in React, Next.js, TypeScript, Node.js, JavaScript, and full-stack web development. He has experience with modern frameworks and tools for building scalable web applications.",
        },
      },
      {
        "@type": "Question",
        name: "Where has Chirag Kumar worked?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Chirag has worked at multinational corporations like Stryker and startups like Sourcefuse, gaining experience across different company sizes and environments.",
        },
      },
      {
        "@type": "Question",
        name: "What education does Chirag Kumar have?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "Chirag is an alumnus of the Noida Institute of Engineering and Technology (NIET), one of India's premier technical institutions.",
        },
      },
    ],
  };
